...
public class CommentPrivateController {
    ...
    public CommentResponseDto createComment(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошено добавление нового комментария => {}, пользователем по id => {}, " +
    ...
    public CommentResponseDto getCommentByIdAndUserId(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошен комментарий по id => {}, пользователем по id => {}", commentId, userId);
    ...
    public CommentResponseDto updateComment(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошено обновление комментария по id => {}, пользователем по id => {}",
                commentId, userId);
    ...
    public void deleteComment(@Positive @PathVariable long commentId,
        ...
        log.info("EWM-SERVER-private => Запрошено удаление комментария по id => {}, пользователем по id => {}",
                commentId, userId);
