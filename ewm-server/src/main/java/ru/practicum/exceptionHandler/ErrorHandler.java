...
public class ErrorHandler {
    ...
    public ApiError errorBadRequestException(
        ...
        log.warn("EWM-SERVER => " + e.getMessage(), e);
        return ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .status(BAD_REQUEST)
                .reason("EWM-SERVER => errorBadRequestException")
    ...
    public ApiError errorMismatchedInputException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(BAD_REQUEST)
                .reason("EWM-SERVER => errorMismatchedInputException")
    ...
    public ApiError errorMissingServletRequestParameterException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(BAD_REQUEST)
                .reason("EWM-SERVER => errorMissingServletRequestParameterException")
                .message(e.getMessage())
                .build();
    }
    ...
    public ApiError errorMissingRequestHeaderException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(BAD_REQUEST)
                .reason("EWM-SERVER => errorMissingRequestHeaderException")
                .message(e.getMessage())
                .build();
    }
    ...
    public ValidationApiError errorConstraintValidationException(
        ...
        final List<Violation> errorPathVariable = e.getConstraintViolations()
                ...
                .map(error -> Violation
                        ...
                        .timestamp(LocalDateTime.now())
                        .status(BAD_REQUEST)
                        .reason("EWM-SERVER => errorConstraintValidationException")
    ...
    public ValidationApiError errorMethodArgumentNotValidException(
        ...
        final List<Violation> errorRequestBody = e.getBindingResult()
                ...
                .map(error -> Violation
                        ...
                        .timestamp(LocalDateTime.now())
                        .status(BAD_REQUEST)
                        .reason("EWM-SERVER => errorMethodArgumentNotValidException")
    ...
    public ApiError errorNotFoundException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(NOT_FOUND)
                .reason("EWM-SERVER => errorNotFoundException")
                .message(e.getMessage())
                .build();
    }
    ...
    public ApiError errorDataIntegrityViolationException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(CONFLICT)
                .reason("EWM-SERVER => errorDataIntegrityViolationException")
    ...
    public ApiError errorConflictException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(CONFLICT)
                .reason("EWM-SERVER => errorConflictException")
                .message(e.getMessage())
                .build();
    }
    ...
    public ApiError errorSQLIntegrityConstraintViolationException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(CONFLICT)
                .reason("EWM-SERVER => errorSQLIntegrityConstraintViolationException")
    ...
    public ApiError errorSQLSyntaxErrorException(
        ...
        return ApiError
                ...
                .timestamp(LocalDateTime.now())
                .status(CONFLICT)
                .reason("EWM-SERVER => errorSQLSyntaxErrorException")
                .message(e.getMessage().substring(0, endIndex))
                .build();
    }
    ...
    public ApiError errorInternalServerErrorException(final Throwable e) {
        ...
        return ApiError
                ...
                .reason("EWM-SERVER => errorInternalServerErrorException")
