...
public class ParticipationPrivateController {
    ...
    public List<ParticipationResponseDto> getUserParticipation(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошен список запросов на участие пользователем по id => {}, " +
    ...
    public ParticipationResponseDto createParticipation(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошено создание запроса на участие в событии по id => {}, пользователем по id => {}",
                eventId, userId);
    ...
    public ParticipationResponseDto cancelParticipation(@Positive @PathVariable long userId,
        ...
        log.info("EWM-SERVER-private => Запрошено удаление запроса на участие по id => {}, пользователем по id => {}",
                requestId, userId);
